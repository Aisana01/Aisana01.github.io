...
<head>
    ...
    <script src="javascript/fill_profile.js"></script>
            ...
            <div class="container1">
                <div class="main_section">
                    <div id="scene" class="background_profile" data-hover-only="true" data-relative-input="true">
                        <img src="image/background_4.png" data-depth="0.2"  alt="">
                    </div>
                    <div class="profile_block">
                        <div class="img_user_block">
                            <svg class="header_logo" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs"
                                version="1.1" width="100" height="100" x="0" y="0" viewBox="0 0 460.8 460.8"
                                style="margin-top: 20px; enable-background:new 0 0 512 512" xml:space="preserve"
                                class="">
                                <g>
                                    <g xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            <path
                                                ...
                                                fill=#2D426D data-original="#000000" style="" class="" />
                                        </g>
                                    </g>
                                    <g xmlns="http://www.w3.org/2000/svg">
                                        <g>
                        ...
                        <div class="user_inform_form">
                            <form class="landing_form_input">
                                ...
                                <div class="form_wrap">
                                    ...
                                    <input class="form_control" type="text" name="" id="user_name"><span class="form_validation"></span></div>
                                <div class="form_wrap">
                                    <!-- <label class="input_label" >Фамилия</label> -->
                                    <input class="form_control" type="text" name="" id="user_surname"><span class="form_validation"></span></div>
                                <div class="form_wrap">
                                    <!-- <label class="input_label">Email</label> -->
                                    <input class="form_control" type="email" name="" id="user_email"><span class="form_validation"></span></div>
                                <div class="form_wrap">
