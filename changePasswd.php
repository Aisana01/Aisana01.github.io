...
<body>
                            ...
                            <form class="landing_form_input">
                                <div class="form_wrap">
                                    ...
                                    <div class="passw_block">
                                        <input id="old_password" class="form_control" type="password" name="" name
                                ...
                                <div class="form_wrap">
                                    <!-- <label class="input_label" >Номер-телефона</label> -->
                                    <div class="passw_block">
                                        <input id="new_password1" class="form_control" type="password" name="" name
                                ...
                                <div class="form_wrap">
                                    <input id="new_password2" class="form_control" type="password" name="" name
                                        placeholder="Подтвердите новый пароль"><span class="form_validation"></span>
                                </div>
                                <div class="form_wrap_calc">
                                    <button class="button_primary" type="button"
                                        onclick="changePassword()">Сохранить</button>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    $('.toggle-password2').on('click', function() {
        $(this).toggleClass('fa-eye fa-eye-slash');
        var input2 = document.getElementById('new_password1');
